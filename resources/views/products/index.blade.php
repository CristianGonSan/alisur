            ...
            <div class="card-header d-flex justify-content-between align-items-center">
                <form action="{{ route('products.search') }}" method="GET" class="form-inline my-2 my-lg-0">
                    <div class="input-group">
                        <input class="form-control" type="search" placeholder="Buscar Por Nombre" aria-label="Buscar"
                               name="search">
                        <div class="input-group-append">
                            <button class="btn btn-outline-success" type="submit" id="searchButton">
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="blue"
                                    ...
                                    <path
                                        d="M11.742 9.344a5.5 5.5 0 1 0-1.397 1.397l3.85 3.85a1 1 0 0 0 1.415-1.414l-3.85-3.85zM10.5 7.5a3 3 0 1 1-6 0 3 3 0 0 1 6 0z"/>
                                </svg>
                            </button>
                        </div>
                    </div>
                                ...
                                <div class="card-body" style="background-color: #e3f2fd;">
                                    <p class="card-text">
                                        ...
                                        <a href="{{ route('products.show', $product->id_producto) }}"
                                           ...
                                           style="background-color: #007bff; border-color: #007bff;">Ver más</a>
                                    </p>
                                </div>
                            </div>
                        </div>
